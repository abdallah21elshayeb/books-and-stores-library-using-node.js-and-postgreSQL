...
exports.queryList = {
  ...
  GRT_STORE_LIST_QUERY : "SELECT STORE_ID, STORE_NAME, STORE_CODE, CREATED_ON, CREATED_BY, ADDRESS FROM BMS.STORE",

  SAVE_STORE_QUERY : "INSERT INTO BMS.STORE (STORE_NAME, STORE_CODE, ADDRESS,CREATED_ON, CREATED_BY) VALUES($1, $2, $3, NULLIF($4,'')::timestamp, $5)",
...
SAVE_BOOK_QUERY : "INSERT INTO BMS.BOOK (BOOK_TITLE, BOOK_DESCRIPTION, BOOK_AUTHOR, BOOK_PUBLISHER, BOOK_PAGES, STORE_CODE, CREATED_BY, CREATED_ON) VALUES($1, $2, $3, $4,$5, $6, $7, $8)",

UPDATE_BOOK_QUERY : "UPDATE BMS.BOOK SET BOOK_TITLE=$1, BOOK_DESCRIPTION=$2, BOOK_AUTHOR=$3, BOOK_PUBLISHER=$4, BOOK_PAGES=$5, STORE_CODE=$6, CREATED_BY=$7 , CREATED_ON=$8 WHERE BOOK_ID= $9",
